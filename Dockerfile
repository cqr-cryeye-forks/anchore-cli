FROM registry.access.redhat.com/ubi8/ubi:8.4 as anchore-cli-builder
...
FROM registry.access.redhat.com/ubi8/ubi:8.4 as anchore-cli-final

ARG CLI_COMMIT
ARG ANCHORE_CLI_VERSION="1.0.0"
